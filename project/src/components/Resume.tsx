        ...
        <div className="mt-12 max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              ...
              <ul className="mt-2 list-disc list-inside text-gray-600">
                ...
                <li>Contributed to the team's flagship event, comprising 100+ participants.</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="mt-2 list-disc list-inside text-gray-600">
                <li>Coordinated the team to create unique works for the society’s social media handles.</li>
                <li>Collaborated with other sectors of the society to successfully execute both online and offline events.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Mar Baselios College of Engineering and Technology • 2023 - 2027</p>
